...
janela = Tk()
janela.title('Codemy.com - Canvas Entry Boxes')
janela.geometry("323x576")
# make sure app can't be resized
janela.resizable(width=False, height=False)

# Define Background Image
bg = ImageTk.PhotoImage(file=r'C:\Users\NTB-G01\OneDrive - Etec Centro Paula Souza\imagens\English1.png')

# Define Canvas
my_canvas = Canvas(janela, width=323, height=576, bd=0, highlightthickness=0)
...
# Define Entry Boxes
un_entry = Entry(janela, font=("Helvetica", 24), width=14, fg="#336d92", bd=0)
pw_entry = Entry(janela, font=("Helvetica", 24), width=14, fg="#336d92", bd=0)
...
# Define Button
login_btn = Button(janela, text="Login", font=("Helvetica", 20), width=15, fg="#336d92", command=welcome)
